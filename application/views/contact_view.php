			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4">
					...
					<ul class="font-11 list-relative list-li-pl-30 list-block list-li-mb-15">
						<li><i class="abs-tl ion-ios-location"></i>Paramount Hill Golf Blok GGT No.112 <br /> Paramount Serpong, Pagedangan,<br /> Kab. Tanggerang, <br /> Kode pos : 15332, <br /> Banten Indonesia.</li>
						<li><i class="abs-tl ion-android-mail"></i>Otoexpert@gmail.com</li>

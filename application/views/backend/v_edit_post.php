                        ...
                        <div class="sidebar-profile">
                            ...
                            if ($query->num_rows() > 0) :
                                ...
                                <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Topsis</p><span class="arrow"></span></a>
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo site_url('backend/kriteria'); ?>">Data Kriteria</a></li>
                                        <li><a href="<?php echo site_url('backend/alternatif');?>">Data Alternatif</a></li>
                                        ...
                                        <div class="col-md-8">
                                            <div class="panel panel-white">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="slug" value="<?php echo $b['post_slug']; ?>" class="form-control" placeholder="Permalink" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">Contents</label>
                                                        <textarea name="contents" id="summernote" cols="6" rows=12 class="form-control"><?php echo $b['post_contents']; ?></textarea>
                                                    </div>

...
<html>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Post</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?= site_url('backend/post/add_new');?>">Add New</a></li>
                                <li><a href="<?= site_url('backend/post');?>">Post List</a></li>
                                <li class="active"><a href="<?= site_url('backend/category');?>">Category</a></li>
                                <li><a href="<?= site_url('backend/tag');?>">Tag</a></li>
                            </ul>
                        </li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Topsis</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?= site_url('backend/kriteria');?>">Kriteria</a></li>
                                <li><a href="<?= site_url('backend/alternatif');?>">Alternatif</a></li>
                                <li><a href="<?= site_url('backend/hasil_topsis');?>">Hasil Topsis</a></li>
                            </ul>
                        </li>
                        ...
                        <?php else:?>
                        <?php endif;?>
                        <li><a href="<?= site_url('logout');?>" class="waves-effect waves-button"><span class="menu-icon icon-logout"></span><p>Log Out</p></a></li>
                                        ...
                                        <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $row->nama_alt;?></td>
                                                    <td>
                                                        <img src="<?= base_url() . 'assets/images/' . $row->gambar; ?>" width="80px">
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?= $row->id_alt;?>" data-category="<?= $row->nama_alt;?>"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $row->id_alt;?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
        ...
        <!--ADD RECORD MODAL-->
        <form action="<?= site_url('backend/alternatif/save');?>" method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="kode" class="form-control" placeholder="Cth : A01" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="alternatif" class="form-control" placeholder="Masukan Alternatif" required>
                            </div>
                            <!-- <div class="form-group"> -->
                                <input type="hidden" name="image" class="form-control" placeholder="Masukan Alternatif" required>
                            <!-- </div> -->
                        </div>
        ...
        <!--EDIT RECORD MODAL-->
        <form action="<?= site_url('backend/alternatif/edit');?>" method="post">
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?= site_url('backend/alternatif/delete');?>" method="post">
            <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Alternatif</h4>
                    </div>
                        <div class="modal-body">
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.btn-edit').on('click',function(){
                    var id=$(this).data('id_alt');
                    var name=$(this).data('alternatif');
                    $('[name="id"]').val(id);
                    $('[name="kode"]').val(kode);

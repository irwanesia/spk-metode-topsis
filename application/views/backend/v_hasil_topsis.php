        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Data Hasil Topsis</h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('backend/dashboard');?>">Dashboard</a></li>
                            <li><a href="#">Post</a></li>
                            <li class="active">Hasil Topsis</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    	Harga : <?= $row->k01;?> </br> 
                                                    	BBM : <?= $row->k02;?> </br>
                                                    	Fitur Keselamatan : <?= $row->k03;?> </br>
                                                    	Kap Shit : <?= $row->k04;?> </br>
                                                    	Mesin : <?= $row->k05;?>
                                                    </td>
                                                    <td><?= $row->date;?></td>
                                                    <td style="text-align: center;">
                                                        <a href="<?= site_url('backend/detail_perhitungan_topsis/index/'. $row->id);?>" class="btn btn-xs btn-delete" data-id="<?= $row->id;?>"><span class="fa fa-eye"></span></a>
                                                        | <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $row->id;?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>

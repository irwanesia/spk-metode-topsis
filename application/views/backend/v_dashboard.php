            ...
            <div class="page-sidebar">
                    ...
                    <div class="sidebar-header">
                        <div class="sidebar-profile">
                            ...
                            <div class="page-inner"> 
                                <div class="page-title" style="margin-left: -140px;">
                                    <h3>Dashboard</h3>
                                ...
                                <div id="main-wrapper"  style="margin-left: -140px;">
                                    <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="visitors-chart">
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">DATA TOPSIS</h4>
                                                                <div style="width: 800px; height: 800px;">
                                                                    <canvas id="myChart"></canvas>
                                                                     <h1>test data</h1>
                                                                     <?php
                                                                    //     $sql = "SELECT * FROM tbl_topsis";
                                                                    //     $topsis = $this->db->query($sql);

                                                                    // //Inisialisasi nilai variabel awal
                                                                    //     // $alternatif= "";
                                                                    //     // $jumlah=null;
                                                                    //     foreach ($topsis->result_array() as $item)
                                                                    //     {
                                                                    //         // $alt=$item->nama_alt;
                                                                    //         // $alternatif .= "'$alt'". ", ";
                                                                    //         // $tot=$item->total;
                         ...
                         <div class="page-footer">
                            <p class="no-s"><?php echo date('Y');?> &copy; Otoexpert.</p>
                        </div>
                    </div><!-- Page Inner -->
                </main><!-- Page Content -->
             ...
             var ctx = document.getElementById('myChart').getContext('2d');
                var chart = new Chart(ctx, {
                    ...
                    data: {
                        labels: [<?php echo $alternatif; ?>],
                        datasets: [{
                            label:'Data Hasil Rekomendasi Topsis Mobil MPV ',
                            backgroundColor: ['rgb(255, 99, 132)','rgba(56, 86, 255, 0.87)', 'rgb(60, 179, 113)','rgb(175, 238, 239)','rgb(60, 179, 113)','rgb(255, 99, 132)','rgba(56, 86, 255, 0.87)', 'rgb(60, 179, 113)','rgb(255, 99, 132)','rgba(56, 86, 255, 0.87)'],

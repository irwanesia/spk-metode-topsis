...
<html>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?= $row->id_krt;?>" data-category="<?= $row->nama_krt;?>"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $row->id_krt;?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
        ...
        <!--ADD RECORD MODAL-->
        <form action="<?php echo site_url('backend/kriteria/save');?>" method="post">
